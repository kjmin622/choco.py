...
class Game:
    def __init__(self):
        ...
        #게임 컨트롤 변수
        pygame.display.set_caption('whsskgkrlrnlcksgektlqkf zzzz wlsWk roglaemsp zz')                                      # 창 이름 설정
        ...
        # 리소스 불러오기
        self.spriteSheet_player = SpriteSheet('character.png', 16, 16, 8, 8, 12)      # 플레이어 스프라이트 시트
        self.spriteSheet_object = SpriteSheet('spriteSheet2.png', 8, 8, 16, 16, 45)      # 공통 오브젝트 스프라이트 시트
        self.spriteSheet_map1 = SpriteSheet('map1.png', 8, 8, 16, 16, 87)         # 지형 1 스프라이트 시트
