...
def init(screen, clock):
    scriptdata = textscript.Script([["script1_bg.png",AGENT_C,["[요원 C]이번 임무에 투입된 요원 Q와의 연락이 방금 끊어졌다","[요원 C]무슨 일이 생긴 것 같으니 즉시 현장으로 출동하도록."]],
                                ["script1_bg.png",AGENT_T,["[요원 T]흠... 이 시간대면 도로를 지나가는 것이 최단 루트겠군","[요원 T]본부에 의하면... '공사중'...? 이게 뭐지?"]],
                                ])
