...
class script:
    ...
    def __init__(self, screen_list): 
        ...
        self.now = [0,0]
        self.gamefont = pygame.font.Font(os.path.join(DIR_FONT, DEFAULT_FONT_NAME),30)
    ...
    def get_draw_image(self):
        ...
        textbox = pygame.image.load(os.path.join(DIR_IMAGE, "testscriptbox.png"))
        textbox.set_colorkey((255,255,255))
        text = self.screen_list[self.now[0]][2][self.now[1]]
