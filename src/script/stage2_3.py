...
def init(screen, clock):
    scriptdata = script.script([["testbackground.png",CHR_EMPTY,["두 요원이 탈출에 성공하나 싶었지만","'요원 Q'의 탈출장치가 고장나 출구에서 빠져나올 수 없다","결국 '요원 T'가 다시 본부에 복귀해서","탈출 장치를 가져오기로 하고 발걸음을 서둘렀다"]],
